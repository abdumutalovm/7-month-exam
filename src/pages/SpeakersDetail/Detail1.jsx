...
import img1 from '../../assets/product-zx9-speaker/desktop/img1.png';

import img2 from '../../assets/product-zx9-speaker/desktop/first.png';
import img3 from '../../assets/product-zx9-speaker/desktop/second.png';
import img4 from '../../assets/product-zx9-speaker/desktop/third.png';
...
import img7 from '../../assets/product-zx9-speaker/desktop/img7.png';
        ...
        <div className='bg-white w-[1540px] mx-auto'>
            ...
            <div className='w-[1110px] flex mb-[160px] items-center justify-between mx-auto '>
                <div className='h-[590px] flex flex-col justify-between'>
                    <img src={img2} alt="boy img" />
                    <img src={img3} alt="headphone img" />
                </div>
                <div>
                    <img src={img4} alt="black headphones img" />
                </div>
            </div>
                ...
                <div className='flex items-center justify-between'>
                    <div className='w-[350px] h-[471px]'>
                        ...
                        <div className='about flex flex-col justify-between px-[80px]'>
                            <h1 className='text-center text-black font-semibold mt-[40px] mb-[32px] text-[24px] tracking-[2px] leading-5'>ZX7 SPEAKER</h1>
                            <button onClick={goZx7} className='px-6 mb-[160px] py-2.5 text-[13px] font-semibold bg-orange-500 text-white'>SEE PRODUCT</button>
                        </div>
                    </div>
                    ...
                    <div className='w-[350px] h-[471px]'>
                        ...
                        <div className='about flex flex-col justify-between px-[80px]'>
                            <h1 className='text-center text-black font-semibold mt-[40px] mb-[32px] text-[24px] tracking-[2px] leading-5'>XX 59</h1>
