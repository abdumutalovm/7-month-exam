...
import img1 from '../../assets/product-zx7-speaker/desktop/img1.png';

import first from '../../assets/product-zx7-speaker/desktop/first.png';
import second from '../../assets/product-zx7-speaker/desktop/second.png';
import third from '../../assets/product-zx7-speaker/desktop/thrid.png';
        ...
        <div className='bg-white w-[1540px] mx-auto'>
            ...
            <div className='w-[1110px] flex mb-[160px] items-center justify-between mx-auto '>
                <div className='h-[590px] flex flex-col justify-between'>
                    <img src={first} alt="boy img" />
                    <img src={second} alt="headphone img" />
                </div>
                <div>
                    <img src={third} alt="black headphones img" />
                </div>
            </div>
