...
import img1 from '../../assets/product-yx1-earphones/desktop/earphones-page.jpg';

import first from '../../assets/product-yx1-earphones/desktop/first.jpg';
import second from '../../assets/product-yx1-earphones/desktop/second.jpg';
import third from '../../assets/product-yx1-earphones/desktop/third.jpg';
    ...
    return (
        <div className='bg-white w-[1540px] mx-auto'>
            ...
            <div className='w-[1540px] mx-auto mt-[79px] px-44 '>
                <Link to='/earphones' className='leading-6 text-[15px] hover:underline'>Go back</Link>
            </div>
            ...
            <div className='w-[1110px] flex mb-[160px] items-center justify-between mx-auto '>
                <div className='h-[590px] flex flex-col justify-between'>
                    <img src={third} alt="boy img" />
                    <img src={second} alt="headphone img" />
                </div>
                <div>
                    <img src={first} alt="black headphones img" />
                </div>
            </div>
