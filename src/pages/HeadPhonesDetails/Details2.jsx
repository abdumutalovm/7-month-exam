...
import img1 from '../../assets/headphones/img2.png';
import img70 from '../../assets/product-xx99-mark-one-headphones/desktop/img7.png'
import img71 from '../../assets/product-xx99-mark-one-headphones/desktop/img8.png'
import img72 from '../../assets/product-xx99-mark-one-headphones/desktop/img9.png'
import img5 from '../../assets/product-xx99-mark-one-headphones/desktop/mark2.png';
import img6 from '../../assets/product-xx99-mark-one-headphones/desktop/xx59.png';
import img7 from '../../assets/product-xx99-mark-one-headphones/desktop/zx9.png';
        ...
        <div className='bg-white w-[1540px] mx-auto'>
            ...
            <div className='bg-white flex items-center justify-between w-[1440px] px-44 mt-20 mx-auto'>
                ...
                <div className='about-product w-[445px]'>
                    ...
                    <h3 className='text-black tracking-[1px] leading-[25px font-bold mb-10'>$ {data?.price}</h3>
            ...
            <div className='w-[1110px] flex mb-[160px] items-center justify-between mx-auto '>
                <div className='h-[590px] flex flex-col justify-between'>
                    <img src={img70} alt="boy img" />
                    <img src={img72} alt="headphone img" />
                </div>
                <div>
                    <img src={img71} alt="black headphones img" />
                </div>
            </div>
                ...
                <div className='flex items-center justify-between'>
                    <div className='w-[350px] h-[471px]'>
                        ...
                        <div className='about flex flex-col justify-between px-[80px]'>
                            <h1 className='text-center text-black font-semibold mt-[40px] mb-[32px] text-[24px] tracking-[2px] leading-5'>XX99 MARK II</h1>
                            <button onClick={goMark2} className='px-6 mb-[160px] py-2.5 text-[13px] font-semibold bg-orange-500 text-white'>SEE PRODUCT</button>
                        </div>
                    </div>
                    ...
                    <div className='w-[350px] h-[471px]'>
                        ...
                        <div className='about flex flex-col justify-between px-[80px]'>
                            ...
                            <button onClick={goXx59} className='px-6 mb-[160px] py-2.5 text-[13px] font-semibold bg-orange-500 text-white'>SEE PRODUCT</button>
                        </div>
                    </div>
