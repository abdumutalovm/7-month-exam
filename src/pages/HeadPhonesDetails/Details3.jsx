...
import img1 from '../../assets/product-xx59-headphones/desktop/img1.png';

import img70 from '../../assets/product-xx59-headphones/desktop/girl.png'
import img71 from '../../assets/product-xx59-headphones/desktop/book.png'
import img72 from '../../assets/product-xx59-headphones/desktop/earphone.png'

import img5 from '../../assets/product-xx59-headphones/desktop/first.png';
import img6 from '../../assets/product-xx59-headphones/desktop/second.png';
import img7 from '../../assets/product-xx59-headphones/desktop/third.png';
        ...
        <div className='bg-white w-[1540px] mx-auto'>
            ...
            <div className='w-[1110px] flex mb-[160px] items-center justify-between mx-auto '>
                <div className='h-[590px] flex flex-col justify-between'>
                    ...
                    <img src={img71} alt="headphone img" />
                </div>
                <div>
                    <img src={img72} alt="black headphones img" />
                </div>
            </div>
            ...
            <div className='w-[1110px] mx-auto'>
                ...
                <div className='flex items-center justify-between'>
                    ...
                    <div className='w-[350px] h-[471px]'>
                        ...
                        <div className='about flex flex-col justify-between px-[80px]'>
                            <h1 className='text-center text-black font-semibold mt-[40px] mb-[32px] text-[24px] tracking-[2px] leading-5'>XX99 MARK I</h1>
